...
new = '<div class="logo-box"><img src="{{ \"/assets/ajin_logo.png\" | relative_url }}" alt="아진네트웍스 로고" style="height:40px;width:auto;display:block;" /></div>'
...
if old in content:
    ...
    print('⚠ 대상 코드 미발견 — 현재 296번줄 내용을 확인하세요')
