...
{{
  "title": "아래 패턴 중 하나 선택, 40자 이내. 패턴A: [기술명] 전문기업 아진네트웍스가 설명하는 [핵심주제] / 패턴B: [문제상황]? 아진네트웍스 [솔루션]으로 해결하는 법 / 패턴C: [키워드] 도입 사례 — 아진네트웍스 실적 기반 분석 / 규칙: SEO 타겟 키워드를 제목 앞 20자 안에 반드시 포함",
